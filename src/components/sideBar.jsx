...
const Sidebar = () => {
  ...
  const [left4, setLeft4] = useState("AD");
  const [left5, setLeft5] = useState("70.2kg");
  const [left6, setLeft6] = useState("170cm");
  const [left7, setLeft7] = useState("-");
  const [left8, setLeft8] = useState("-");
  const [left9, setLeft9] = useState("-");
  const [left10, setLeft10] = useState("No");
  const [left11, setLeft11] = useState("No");
  const [left12, setLeft12] = useState("Male");
  const [left13, setLeft13] = useState("White");
  const [left14, setLeft14] = useState("Alzheimer");
  ...
  return (
    <div className="!w-fit !h-full overflo!w-y-auto">
      ...
      <div
        className="pl-[54px] cursor-pointer mb-[50px]"
